...
public:
    ...
    virtual void OnRspQryBrokerTradingParams(
        ...
        if ( (pRspInfo) && (pRspInfo->ErrorID != 0) )  {
            ...
            printf("OnRspQryBrokerTradingParams():出错:ErrorId=%d,ErrorMsg=%s\n",pRspInfo->ErrorID,ErrorMsg);
        }
        ...
        if ( pBrokerTradingParams != NULL ) {
            ...
            ///经纪公司代码 TThostFtdcBrokerIDType char[11]
            char BrokerID[33];
            gbk2utf8(pBrokerTradingParams->BrokerID,BrokerID,sizeof(BrokerID));
            ///投资者代码 TThostFtdcInvestorIDType char[13]
            char InvestorID[39];
            gbk2utf8(pBrokerTradingParams->InvestorID,InvestorID,sizeof(InvestorID));
            ///保证金价格类型 TThostFtdcMarginPriceTypeType char
            ...
            char MarginPriceType = pBrokerTradingParams->MarginPriceType;
            ///盈亏算法 TThostFtdcAlgorithmType char
            ...
            char Algorithm = pBrokerTradingParams->Algorithm;
            ///可用是否包含平仓盈利 TThostFtdcIncludeCloseProfitType char
            //// THOST_FTDC_ICP_Include '0' 包含平仓盈利
            //// THOST_FTDC_ICP_NotInclude '2' 不包含平仓盈利
            char AvailIncludeCloseProfit = pBrokerTradingParams->AvailIncludeCloseProfit;
            ///币种代码 TThostFtdcCurrencyIDType char[4]
            char CurrencyID[12];
            gbk2utf8(pBrokerTradingParams->CurrencyID,CurrencyID,sizeof(CurrencyID));
...
int main() {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // 定义调用API的数据结构
    CThostFtdcQryBrokerTradingParamsField requestData;
    // 确保没有初始化的数据不会被访问
    ...
    // 调用API,并等待响应函数返回
    int result = pTraderApi->ReqQryBrokerTradingParams(&requestData,requestID++);
    sem_wait(&sem);
